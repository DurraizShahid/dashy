...
const selectClasses =
  "rounded-[12px] bg-[#F7F7F8] border border-[#E9E7F0] px-3 py-2 text-sm text-[#28243D] outline-none"
        ...
        <div className="h-full bg-white rounded-[36px] p-5 shadow-elevated">
          <div className="flex gap-5 h-full">
            ...
            <div className="flex-1 flex flex-col min-w-0 overflow-y-auto pr-1">
              ...
              <div className="bg-white rounded-[20px] p-4 shadow-card mb-4 mx-6">
                <div className="flex flex-wrap items-center gap-3">
                  <div className="relative flex-1 min-w-[200px]">
                    <Search className="absolute left-3 top-1/2 size-4 -translate-y-1/2 text-[#7B7592]" />
                    <input
                      type="text"
                      placeholder="Search leads..."
                      value={search}
                      onChange={(e) => setSearch(e.target.value)}
                      className="w-full rounded-[12px] bg-[#F7F7F8] border border-[#E9E7F0] pl-9 pr-3 py-2 text-sm text-[#28243D] outline-none placeholder:text-[#7B7592]"
                    />
                  </div>
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="bg-[#F7F7F8]">
                        ...
                        <th className="text-xs uppercase text-[#7B7592] font-medium px-4 py-3 text-left">Intent</th>
                        ...
                        <th className="text-xs uppercase text-[#7B7592] font-medium px-4 py-3 text-left">Market</th>
                      ...
                      {filteredLeads.map((lead) => {
                        ...
                        return (
                          <tr key={lead.id} className="border-b border-[#E9E7F0] hover:bg-[#F7F7F8] transition-colors">
                            ...
                            <td className="px-4 py-3 text-sm text-[#28243D]">{lead.market}</td>
                            <td className="px-4 py-3 text-sm text-[#7B7592]">{lead.createdAt}</td>
                            <td className="px-4 py-3">
                              <button className="rounded-lg p-1.5 hover:bg-[#F7F7F8] transition-colors">
                                <MoreHorizontal className="size-4 text-[#7B7592]" />
                              </button>
                            </td>
                          </tr>
                        )
