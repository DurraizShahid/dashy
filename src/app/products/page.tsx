            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border">
                  <th scope="col" className="pb-3 text-left text-xs font-medium text-muted-foreground">Company</th>
                  <th scope="col" className="pb-3 text-left text-xs font-medium text-muted-foreground">Contact</th>
                  <th scope="col" className="pb-3 text-left text-xs font-medium text-muted-foreground">Source</th>
                  <th scope="col" className="pb-3 text-left text-xs font-medium text-muted-foreground">Market</th>
                  <th scope="col" className="pb-3 text-left text-xs font-medium text-muted-foreground">Score</th>
                  <th scope="col" className="pb-3 text-left text-xs font-medium text-muted-foreground">Intent</th>
                  <th scope="col" className="pb-3 text-left text-xs font-medium text-muted-foreground">Status</th>
                  <th scope="col" className="pb-3 text-left text-xs font-medium text-muted-foreground">Assigned</th>
                </tr>
              </thead>
              <tbody>
